 ...
 * 如果给定 $Len_Post_Module_Music_key，函数将尝试从 'Len_Post_Module_Music' 中获取对应键的值。
 ...
 * @param string $Len_Post_Module_Music_key  要获取的 'Len_Post_Module_Music_key' 中的键。
 * @param mixed  $default                            如果未找到对应值时返回的默认值。
 *
 * @return mixed 返回获取到的元数据值或默认值。
 */
if (!function_exists('Len_Post_Module')) {
    function _Len_Post_Module($Len_Post_Seo_Module_key = '', $Len_Post_Source_Module_key = '', $Len_Post_Module_Thumbnail_Sidebars_key = '', $Len_Post_Module_Switcher_Sidebars_key = '', $Len_Post_Module_Music_key = '', $post_id = '', $default = null)
    {
        //主要获取模块值
        ...
        // 获取当前文章的 '' 元数据
        $Len_Post_Module_Music = get_post_meta($post_id, 'Len_Post_Music_Module', true);
