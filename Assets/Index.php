...
function Len_scripts_styles()
{
    ...
    wp_enqueue_script('lightbox-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/lightbox.min.js', array(), $var, true);
    ...
    wp_enqueue_style('music-min', get_template_directory_uri() . '/Assets/Len-Css/lightbox.min.css', array(), $var, 'all');
    ...
    wp_enqueue_style('Len-diary', get_template_directory_uri() . '/Assets/Len-Css/music.min.css', array(), $var, 'all');
