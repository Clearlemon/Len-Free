...
function Len_scripts_styles()
{
    ...
    if (is_home()) {
        ...
        wp_enqueue_script('search-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/search.min.js', array(), $var, true);
    } elseif (is_404()) {
        //404页样式和脚本文件
        wp_enqueue_style('404-min', get_template_directory_uri() . '/Assets/Len-Css/404.min.css', array(), $var, 'all');
        wp_enqueue_script('404-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/404.min.js', array(), $var, true);
    } elseif (is_archive()) {
        //分类样式和脚本文件
        wp_enqueue_style('classify-min', get_template_directory_uri() . '/Assets/Len-Css/classify.min.css', array(), $var, 'all');
        wp_enqueue_script('classify-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/classify.min.js', array(), $var, true);
    } elseif (is_single()) {


        //文章内置适配播放器样式和脚本文件
        wp_enqueue_style('plyr-min', get_template_directory_uri() . '/Assets/Len-Css/plyr.min.css', array(), $var, 'all');
        wp_enqueue_script('plyr-umd-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/plyr.min.js', array(), $var, true);
        ...
        wp_enqueue_script('shord-codes-umd-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/shord-codes.min.js', array(), $var, true);
        ...
        wp_enqueue_script('photo-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/photo.min.js', array(), $var, true);
    } elseif (is_page()) {
        //文章内置适配播放器样式和脚本文件
        wp_enqueue_style('plyr-min', get_template_directory_uri() . '/Assets/Len-Css/plyr.min.css', array(), $var, 'all');
        wp_enqueue_script('plyr-umd-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/plyr.min.js', array(), $var, true);
        ...
        //页面脚本
        wp_enqueue_style('page-min', get_template_directory_uri() . '/Assets/Len-Css/page.min.css', array(), $var, 'all');
        wp_enqueue_script('page-min', get_template_directory_uri() . '/Assets/Lne-JavaScript/page.min.js', array(), $var, true);
    ...
    //全局手机端样式
    wp_enqueue_style('mobile-min', get_template_directory_uri() . '/Assets/Len-Css/mobile.min.css', array(), $var, 'all');
...
function Len_Icon()
{
    $Len_Logo_Module_1 = _len('Len_Logo_Module_1');
    return '<link rel="shortcut icon" href="' . $Len_Logo_Module_1 . '" >';
}

function Len_Diy_Cods_($Css = true, $JavaScript = true)
{
    $Len_code_Module_1 = _len('Len_code-Module_1');
    $Len_code_Module_2 = _len('Len_code-Module_2');
    if ($Css == true) {
        $Len_code_Module_1 = "<style>$Len_code_Module_1</style>";
        return  $Len_code_Module_1;
    } elseif ($JavaScript == true) {
        $Len_code_Module_2 = "<script>$Len_code_Module_2</script>";
        return  $Len_code_Module_2;
    }
}
