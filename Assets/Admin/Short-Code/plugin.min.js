! function (u) {
  ...
  var n = function (e) {
    ...
    o = function (e) {
      return Math.min(i.DOM.getViewPort()
        .w, e.getParam("codesample_dialog_width", 800))
    },
    l = function (e) {
      return Math.min(i.DOM.getViewPort()
        .w, e.getParam("codesample_dialog_height", 650))
    },
    t = {},
    r = t,
    ...
    c = function () {
      var c = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
        S = g.Prism = {
          util: {
            encode: function (e) {
              return e instanceof o ? new o(e.type, S.util.encode(e.content), e.alias) : "Array" === S.util.type(e) ? e.map(S.util.encode) : e.replace(/&/g, "&amp;")
                .replace(/</g, "&lt;")
                .replace(/\u00a0/g, " ")
            },
            type: function (e) {
          ...
          highlightElement: function (e, t, a) {
            ...
            if (e.className.indexOf('len-highlight-cod') <= -1) {
              e.classList.add("len-highlight-cod");
            };
            if (e.className.indexOf('line-numbers') <= -1) {
              e.classList.add("line-numbers");
            };
            r && (n = (r.className.match(c) || [, ""])[1], i = S.languages[n]), e.className = e.className.replace(c, "")
              .replace(/\s+/g, " ") + " language-" + n, r = e.parentNode, /pre/i.test(r.nodeName) && (r.className = r.className.replace(c, "")
                .replace(/\s+/g, " ") + "language-" + n);
            var s = e.textContent,
              o = {
                element: e,
                language: n,
            ...
            if (s && i)
              ...
              } else o.highlightedCode = S.highlight(o.code, o.grammar, o.language), S.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, a && a.call(e), S.hooks.run("after-highlight", o), S.hooks.run("complete", o);
      ...
      }, !g.document) return g.addEventListener && g.addEventListener("message", function (e) {
  ...
  void 0 !== r && (r.Prism = c), c.languages.markup = {
    ...
    if ("php" === e.language) {
      for (var t = 0, a = void 0; a = e.tokenStack[t]; t++) e.highlightedCode = e.highlightedCode.replace("{{{PHP" + (t + 1) + "}}}", c.highlight(a, e.grammar, "php")
        .replace(/\$/g, "$$$$"));
  ...
  var d = {
    ...
    h = function (t, a, n) {
      t.undoManager.transact(function () {
        var e = p(t);
        n = i.DOM.encode(n), e ? (t.dom.setAttrib(e, "class", "language-" + a), e.innerHTML = n, c.highlightElement(e), t.selection.select(e)) : (t.insertContent('<pre id="__new" class="language-' + a + '">' + n + "</pre>"), t.selection.select(t.$("#__new")
          .removeAttr("id")[0]))
      })
    },
    m = function (e) {
    ...
    w = function (a) {
      ...
      a.on("PreProcess", function (e) {
        i("pre[contenteditable=false]", e.node)
          ...
          .each(function (e, t) {
            var a = i(t),
              n = t.textContent; /*var language = t.className.match(/language-(\w+)/)[1];var languageHtml = "<code class=\"language-"+language+"\"></code>"*/;
            a.attr("class", i.trim(a.attr("class"))), a.removeAttr("contentEditable"), a.empty()
              .append(i("<code></code>")
                .each(function () {
                  this.textContent = n
                }))
        ...
        e.length && a.undoManager.transact(function () {
          e.each(function (e, t) {
            i(t)
              .find("br")
              .each(function (e, t) {
                t.parentNode.replaceChild(a.getDoc()
                  .createTextNode("\n"), t)
  ...
  e.add("codesample", function (t, e) {
    var a = n(!1);
    w(t), S(t), k(t), t.on("init", function () {
      x(t, e, C, a)
