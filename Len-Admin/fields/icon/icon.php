  ...
  class CSF_Field_icon extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      if (substr($this->value, 0, 5) === 'icon-') {
        echo '<span class="csf-icon-preview' . esc_attr($hidden) . '"><i title="' . esc_attr($this->value) . '" class="' . esc_attr($this->value) . '"><svg class="len-admin-icon" aria-hidden="true"><use xlink:href="#' . esc_attr($this->value) . '"></use></svg></i></span>';
      } else {
        echo '<span class="csf-icon-preview' . esc_attr($hidden) . '"><i title="' . esc_attr($this->value) . '" class="' . esc_attr($this->value) . '"></i></span>';
      }
